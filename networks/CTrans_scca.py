...
class Block_ViT(nn.Module):
    def __init__(self, config, vis, channel_num):
        ...
        #self.channel_attn1 = EPA(input_size=channel_num[0], hidden_size=channel_num[0], proj_size=channel_num[0] * 4)
        ...
        # img_size = 512
        # self.channel_attn1 = EPA(input_size=1024, hidden_size=64, proj_size=64)
        # self.channel_attn2 = EPA(input_size=1024, hidden_size=128, proj_size=64)
        # self.channel_attn3 = EPA(input_size=1024, hidden_size=256, proj_size=64)
        # self.channel_attn4 = EPA(input_size=1024, hidden_size=512, proj_size=32)

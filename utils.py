...
def test_single_volume(image, label, net, classes, patch_size=[256, 256], test_save_path=None, case=None, z_spacing=1, device='cpu'):
    ...
    if len(image.shape) == 3:
        prediction = 0
        # if classes == 2 or classes == 14 or classes == 4:
